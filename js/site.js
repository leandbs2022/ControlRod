class site {
    constructor(nome, telefone, endereco) {
        this.nome = "Leandro Barbosa de Souza"
        this.telefone = 6133725484
        this.endereco = "QNP 16 COPNJUNTO Q"
        alert('nome:' + nome, 'Endereço: ' + endereco, 'Telefone: ' + telefone)
    }
}
...
function pagehome() { window.location.href="cadastro.php" }
function pagelogin() { window.location.href="index.php" }
function login() { window.location.href="index.php" }
function excel() {
    window.location.href="impressao_impr.php"
