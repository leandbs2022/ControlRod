...
<nav class="navbar navbar-expand-lg  style=background-color: #e49e1b">
     <ul class="menu" >
		...
		<li><a href="#">Links</a>
            <ul>
	            <li><a href="http://www.lifeonline.com.br/sistemas_v2/#" target="_black">Lifeonline</a></li>
	            <li><a href="https://sgp.antt.gov.br/src.br.gov.antt/apresentacao/controledeacesso/login.aspx" target="_black">ANNT</a></li>
	            <li><a href="https://docs.google.com/spreadsheets/d/1ggLaqyVo-p1vQZYusKJmcqrn1ait8T4OFLjp3rATkl0/edit#gid=1252986026" target="_black">Tabela Google drive Monitriip</a></li>
	       	</ul>
               </li>
		<li><a href="#">Contato</a>
		    <ul>
	            <li><a href="#">catedral.monitriip@gmail.com.br</a></li>
	        </ul>
		</li>
</ul>
</nav>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                ?>
                                <input type="checkbox" name="se_i" id="se_i" value="1" <?php echo $selecionado; ?>>Segunda
                                <?php
                                ...
                                ?>
                               <input type="checkbox" name="te_i" id="te_i" value="1" <?php echo $selecionado; ?>>Terça
                                <?php
                                ...
                                ?>
                                <input type="checkbox" name="qua_i" id="qua_i" value="1" <?php echo $selecionado; ?>>Quarta
                                <?php
                                ...
                                ?>
                                <input type="checkbox" name="qui_i" id="qui_i" value="1" <?php echo $selecionado; ?>>Quinta
                                <?php
                                ...
                                ?>
                                <input type="checkbox" name="sex_i" id="sex_i" value="1" <?php echo $selecionado; ?>>Sexta
                                <?php
                                ...
                                ?>
                                <input type="checkbox" name="sab_i" id="sab_i" value="1" <?php echo $selecionado; ?>>Sábado
                                <?php
                                ...
                                ?>
                                <input type="checkbox" name="dom_i" id="dom_i" value="1" <?php echo $selecionado; ?>>Domingo
                            </td>
                        </tr>
                        </h6>
                </div>
                <div>
                    <tr>
                        <td> <br>
                            ...
                            ?>
                            <input type="checkbox" name="se_v" id="se_v" value="1" <?php echo $selecionado; ?>>Segunda
                            <?php
                            ...
                            ?>
                            <input type="checkbox" name="te_v" id="te_v" value="1" <?php echo $selecionado; ?>>Terça
                            <?php
                            ...
                            ?>
                            <input type="checkbox" name="qua_v" id="qua_v" value="1" <?php echo $selecionado; ?>>Quarta
                            <?php
                            ...
                            ?>
                            <input type="checkbox" name="qui_v" id="qui_v" value="1" <?php echo $selecionado; ?>>Quinta
                            <?php
                            ...
                            ?>
                            <input type="checkbox" name="sex_v" id="sex_v" value="1" <?php echo $selecionado; ?>>Sexta
                            <?php
                            ...
                            ?>
                            <input type="checkbox" name="sab_v" id="sab_v" value="1" <?php echo $selecionado; ?>>Sábado
                            <?php
                            ...
                            ?>
                           <input type="checkbox" name="dom_v" id="dom_i" value="1" <?php echo $selecionado; ?>> Domingo
                        </td>
                    </tr>
                    </table>
                    </h6>
